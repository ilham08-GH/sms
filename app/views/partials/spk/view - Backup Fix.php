...
function hitung_terbilang_tanggal($tanggal){
    ...
    return [
        ...
        'bulan_terbilang' => strtolower($bulan_nama[$bulan]),
...
?>
 ...
 <br>
                            ...
                            <p class="desc-col">
                                Pada hari ini <b><?= $terbilang['hari']; ?></b>, tanggal 
                                <b><?= $terbilang['tanggal_terbilang']; ?></b>, bulan 
                                <b><?= $terbilang['bulan_terbilang']; ?></b>, tahun 
                                <b><?= $terbilang['tahun_terbilang']; ?></b> 
                            ...
                            <table class="table-pihak">
                                ...
                                <tr>
                                    ...
                                    <td class="desc-col">
                                        ...
                                        <?= safe($data['master_petugas_alamat']); ?>, kecamatan <?= safe($data['master_petugas_kecamatan']); ?>,
                            ...
                            <br>
                             ...
                             <br>
                                ...
                                <ul>
                                    ...
                                    a.	mengundurkan diri setelah pelatihan diberikan sanksi sebesar Rp. <?= rupiah($total_honor_fix); ?>,- (<?= ucfirst(angka_ke_teks($total_honor_fix)); ?> Rupiah) biaya yang dikeluarkan untuk pelatihan/briefing petugas yang telah diterima;
                                </ul>
                                <ul>
                            ...
                            <div class="pasal">
                                Demikian Perjanjian ini dibuat dan ditandatangani oleh <b>PARA PIHAK</b> sebanyak 1 rangkap bermaterai cukup, tanpa paksaan dari <b>PIHAK</b> manapun dan untuk dilaksanakan oleh <b>PARA PIHAK</b>.
                            </div>
                            ...
                            <div style="text-align: center; width: 45%;">
                                ...
                                <!-- Kotak Materai di kiri -->
                                <div style="display: inline-block; border: 1px solid #000; padding: 5px 10px; font-size: 8px; text-align: center; float: left;margin-left: 40px;">
                                    Materai 10.000
                                </div><br><br>
                                
                                <span style="font-weight: bold; font-family:'Bookman Old Style';">
                                    <?= safe($data['master_petugas_nama_petugas']); ?>
                                </span>
                            </div>
                        
                            <!-- Kolom PIHAK PERTAMA -->
                            <div style="text-align: center; width: 45%;">
                                <b>PIHAK PERTAMA,</b><br><br><br><br><br><br>
                                <span style="font-weight: bold; font-family:'Bookman Old Style';">
