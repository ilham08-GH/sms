...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Spk</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("spk/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nomor_spk"  value="<?php  echo $data['nomor_spk']; ?>" type="text" placeholder="Masukkan Nomor SPK"  required="" name="nomor_spk"  data-url="api/json/spk_nomor_spk_value_exist/" data-loading-msg="Sedang memeriksa ..." data-available-msg="Available" data-unavailable-msg="Data sudah ada" class="form-control  ctrl-check-duplicate" />
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-id_petugas_spk" data-load-path="<?php print_link('api/json/spk_id_petugas_spk_option_list') ?>" name="id_petugas_spk"  placeholder="--Pilih Data--"    class="custom-select" >
                                                        <?php
                                                        $rec = $data['id_petugas_spk'];
                                                        $id_petugas_spk_options = $comp_model -> spk_id_petugas_spk_option_list($data['bulan_spk']);
                                                        if(!empty($id_petugas_spk_options)){
                                                        foreach($id_petugas_spk_options as $option){
                                                        $value = (!empty($option['value']) ? $option['value'] : null);
                                                        $label = (!empty($option['label']) ? $option['label'] : $value);
                                                        $selected = ( $value == $rec ? 'selected' : null );
                                                        ?>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-honor_pelatihan"  value="<?php  echo $data['honor_pelatihan']; ?>" type="number" placeholder="Denda" step="1"  required="" name="honor_pelatihan"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
