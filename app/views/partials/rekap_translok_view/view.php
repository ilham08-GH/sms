...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Rekap Translok View</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-id_matrik_translok">
                                        ...
                                        <td class="value"> <?php echo $data['id_matrik_translok']; ?></td>
                                    </tr>
                                    <tr  class="td-id_user">
                                    ...
                                    <tr  class="td-volume">
                                        ...
                                        <td class="value"> <?php echo $data['volume']; ?></td>
                                    </tr>
                                    <tr  class="td-satuan">
                                    ...
                                    <tr  class="td-id_bulan_pengajuan">
                                        ...
                                        <td class="value"> <?php echo $data['id_bulan_pengajuan']; ?></td>
                                    </tr>
                                    <tr  class="td-tahun">
