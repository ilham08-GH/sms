                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nip"  value="<?php  echo $data['nip']; ?>" type="number" placeholder="Masukkan NIP" step="1"  required="" name="nip"  data-url="api/json/user_nip_value_exist/" data-loading-msg="Sedang memeriksa ..." data-available-msg="Available" data-unavailable-msg="Data sudah ada" class="form-control  ctrl-check-duplicate" />
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-nama_user"  value="<?php  echo $data['nama_user']; ?>" type="text" placeholder="Masukkan Nama User"  required="" name="nama_user"  data-url="api/json/user_nama_user_value_exist/" data-loading-msg="Sedang memeriksa ..." data-available-msg="Available" data-unavailable-msg="Data sudah ada" class="form-control  ctrl-check-duplicate" />
                                                        <div class="check-status"></div> 
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-email"  value="<?php  echo $data['email']; ?>" type="email" placeholder="Masukkan Email"  required="" name="email"  data-url="api/json/user_email_value_exist/" data-loading-msg="Sedang memeriksa ..." data-available-msg="Available" data-unavailable-msg="Data sudah ada" class="form-control  ctrl-check-duplicate" />
                                                                <div class="check-status"></div> 
                                                            </div>
                                                        </div>
                                                    </div>
