...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Matrik Honor dengan SP2D CLEAR</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('matrik_honor/List_tu'); ?>" method="get">
            ...
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <a  class="btn btn-success" href="<?php print_link("matrik_honor/list_tu_sp2d_clear") ?>">
                            <i class="fa fa-th-list "></i>                              
                            Matrik Honor SP2D CLEAR 
                        </a>
            ...
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-md-2 comp-grid">
                        <div class=""><div>Filter Data Bulan dan Tahun</div>
                        </div>
                    </div>
                    <div class="col-sm-3 comp-grid">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                <div class="p-2">
                                    <select   name="master_bulan_bulan" class="form-control custom ">
                                        ...
                                        <?php 
                                        $master_bulan_bulan_options = $comp_model -> matrik_honor_master_bulanbulan_option_list();
                            ...
                            <div class="card mb-3">
                                <div class="p-2">
                                    <select   name="matrik_honor_tahun" class="form-control custom ">
                                        <option value="">Select a value ...</option>
                                        <?php 
                                        $matrik_honor_tahun_options = $comp_model -> matrik_honor_matrik_honortahun_option_list();
                                        if(!empty($matrik_honor_tahun_options)){
                                        foreach($matrik_honor_tahun_options as $option){
                                        $value = (!empty($option['value']) ? $option['value'] : null);
                                        $label = (!empty($option['label']) ? $option['label'] : $value);
                                        $selected = $this->set_field_selected('matrik_honor_tahun',$value);
                                        ?>
                                        <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                            <?php echo $label; ?>
                                        </option>
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div class="filter-tags mb-2">
                            ...
                            ?>
                            <?php
                            if(!empty(get_value('matrik_honor_tahun'))){
                            ?>
                            <div class="filter-chip card bg-light">
                                <b>Tahun :</b> 
                                <?php 
                                if(get_value('matrik_honor_tahunlabel')){
                                echo get_value('matrik_honor_tahunlabel');
                                }
                                else{
                                echo get_value('matrik_honor_tahun');
                                }
                                $remove_link = unset_get_value('matrik_honor_tahun', $this->route->page_url);
                                ?>
                                <a href="<?php print_link($remove_link); ?>" class="close-btn">
                                    &times;
                                </a>
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="matrik_honor-list_tu_sp2d_clear-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-petugaslist"><a href="<?php print_link("detail_matrik_honor/list_tu/id_matrik_honor/$data[id]") ?>"><?php echo $data['petugaslist']; ?></a></td>
                                            </tr>
                                            <?php 
                                            }
                                            ?>
