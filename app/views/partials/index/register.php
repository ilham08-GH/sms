                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-nama_user"  value="<?php  echo $this->set_field_value('nama_user',""); ?>" type="text" placeholder="Enter Nama User"  required="" name="nama_user"  data-url="api/json/user_nama_user_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="id_tim">Id Tim <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-id_tim"  value="<?php  echo $this->set_field_value('id_tim',""); ?>" type="number" placeholder="Enter Id Tim" step="1"  required="" name="id_tim"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
