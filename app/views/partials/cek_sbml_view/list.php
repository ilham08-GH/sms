...
$can_add = ACL::is_allowed("cek_sbml_view/add");
$can_edit = ACL::is_allowed("cek_sbml_view/edit");
$can_view = ACL::is_allowed("cek_sbml_view/view");
$can_delete = ACL::is_allowed("cek_sbml_view/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Cek Sbml View</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('cek_sbml_view'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('cek_sbml_view'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="cek_sbml_view-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-id_bulan_pelaksanaan"> Id Bulan Pelaksanaan</th>
                                                ...
                                                <th  class="td-satuan2"> Satuan2</th>
                                            </tr>
                                        </thead>
                                        <?php
                                        if(!empty($records)){
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-id_matrik_honor"> <?php echo $data['id_matrik_honor']; ?></td>
                                                ...
                                                <td class="td-id_bulan_pelaksanaan"> <?php echo $data['id_bulan_pelaksanaan']; ?></td>
                                                ...
                                                <td class="td-satuan2"> <?php echo $data['satuan2']; ?></td>
                                            </tr>
                                            <?php 
                                            }
                                            ?>
