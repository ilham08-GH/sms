            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("detail_matrik_honor/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <input id="ctrl-id_matrik_honor"  value="<?php  echo $data['id_matrik_honor']; ?>" type="hidden" placeholder="Masukkan Id Matrik Honor"  readonly required="" name="id_matrik_honor"  class="form-control " />
                                    <input id="ctrl-rincian_output_detail"  value="<?php  echo $data['rincian_output_detail']; ?>" type="hidden" placeholder="Masukkan Rincian Output Detail"  readonly required="" name="rincian_output_detail"  class="form-control " />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-volume_spk"  value="<?php  echo $data['volume_spk']; ?>" type="number" placeholder="Volume SPK" step="1"  required="" name="volume_spk"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-volume_bast"  value="<?php  echo $data['volume_bast']; ?>" type="number" placeholder="Volume BAST" step="1"  readonly required="" name="volume_bast"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
