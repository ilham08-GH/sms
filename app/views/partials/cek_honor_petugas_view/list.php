                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('cek_honor_petugas_view'); ?>" method="get">
                        <div class="input-group">
                            <input value="<?php echo get_value('search'); ?>" class="form-control" type="text" name="search"  placeholder="Masukkan NIK Petugas" />
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('cek_honor_petugas_view'); ?>">
                            ...
                            <div id="cek_honor_petugas_view-list-records">
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-volume_bast"> Volume</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-nama_satuan"> <?php echo $data['nama_satuan']; ?></td>
                                    ...
                                    <h4 class="bg-light text-center border-top text-muted animated bounce  p-3">
                                        <i class="fa fa-ban"></i> Data tidak ditemukan
                                    </h4>
                                    <?php
                                    }
                                    ?>
                                ...
                                <div class=" border-top mt-2">
                                    <div class="row justify-content-center">    
                                                            ...
                                                            <?php
                                                            $is_search = !empty($this->search);
                                                            ?>
                                                            
                                                            <div class="col">
                                                                <?php if($show_pagination && $is_search): ?>
                                                                    <?php
