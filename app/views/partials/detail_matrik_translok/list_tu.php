        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-8 ">
                    ...
                    <span><?= $first['matrik_translok_uraian_pengajuan'] ?? '' ?></span></div>
                </div>
                <div class="col-sm-4 ">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="detail_matrik_translok-list_tu-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-s_non_pkd"> Surat Non PKD</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-st"><?php
                                                    ...
                                                    <span class="toggle-field" 
                                                        ...
                                                        <i class="bi <?= ($data['st']==1?'bi-check-circle-fill text-success':'bi-x-circle-fill text-danger') ?>"></i>
                                                    </span>
                                                    <script>
                                                        ...
                                                        fetch('<?= print_link("detail_matrik_translok/toggle_field") ?>', {
                                                        method: 'POST',
                                                ...
                                                <td class="td-visum"><?php
                                                    ...
                                                    <span class="toggle-field" 
                                                        ...
                                                        data-field="visum" 
                                                        style="cursor:pointer">
                                                        <i class="bi <?= ($data['visum']==1?'bi-check-circle-fill text-success':'bi-x-circle-fill text-danger') ?>"></i>
                                                    </span>
                                                    <script>
                                                        // Event delegation untuk semua toggle-field
                                                        document.addEventListener('click', function(e){
                                                ...
                                                <td class="td-s_non_pkd"><?php
                                                    ...
                                                    <span class="toggle-field" 
                                                        data-id="<?= $data['id'] ?>" 
                                                        data-field="s_non_pkd" 
                                                        style="cursor:pointer">
                                                        <i class="bi <?= ($data['s_non_pkd']==1?'bi-check-circle-fill text-success':'bi-x-circle-fill text-danger') ?>"></i>
                                                    </span>
                                                    <script>
                                                        // Event delegation untuk semua toggle-field
                                                        document.addEventListener('click', function(e){
                                                ...
                                                <td class="td-laporan"><?php
                                                    ...
                                                    <span class="toggle-field" 
                                                        ...
                                                        data-field="laporan" 
                                                        style="cursor:pointer">
                                                        <i class="bi <?= ($data['laporan']==1?'bi-check-circle-fill text-success':'bi-x-circle-fill text-danger') ?>"></i>
                                                    </span>
                                                    <script>
                                                        // Event delegation untuk semua toggle-field
                                                        document.addEventListener('click', function(e){
                                                ...
                                                <td class="td-dokumentasi"><?php
                                                    ...
                                                    <span class="toggle-field" 
                                                        data-id="<?= $data['id'] ?>" 
                                                        data-field="dokumentasi" 
                                                        style="cursor:pointer">
                                                        <i class="bi <?= ($data['dokumentasi']==1?'bi-check-circle-fill text-success':'bi-x-circle-fill text-danger') ?>"></i>
                                                    </span>
                                                    <script>
                                                        // Event delegation untuk semua toggle-field
                                                        document.addEventListener('click', function(e){
