    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("matrik_translok/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Buat Matrik Translok 
                    </a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('matrik_translok'); ?>" method="get">
            ...
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <a  class="btn btn-success" href="<?php print_link("matrik_translok/list_sp2d_clear") ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        <div class=""><div class="alert alert-primary">
                            <strong>Info!</strong> Ubah Status Pengajuan Jika Matrik Translok siap diajukan ke TU dan dilakukan Pembayaran
                        </div></div>
                    </div>
                </div>
            </div>
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="matrik_translok-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-tambahpegawai"> Petugas</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-tambahpegawai"><a href="<?php print_link("detail_matrik_translok/add?id_matrik_translok=$data[id]&harga_satuan=$data[harga_satuan_honor]&kegiatan=$data[uraian_pengajuan]&bulan=$data[id_bulan_pengajuan]&tahun=$data[tahun]") ?>"><?php echo $data['tambahpegawai']; ?></a></td>
                                                    <td class="td-list_petugas"><a href="<?php print_link("detail_matrik_translok/list/id_matrik_translok/$data[id]") ?>"><?php echo $data['list_petugas']; ?></a></td>
                                                    <td class="td-ubah_status"><a href="<?php print_link("matrik_translok/edit_status/$rec_id") ?>"><?php echo $data['ubah_status']; ?></a></td>
                                                    ...
                                                    <td class="page-list-action td-btn">
                                                        <div class="dropdown" >
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <?php if($can_delete){ ?>
                                                                <a  class="dropdown-item record-delete-btn" href="<?php print_link("matrik_translok/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="⚠️ Apakah Anda yakin ingin menghapus data ini?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <?php if($can_delete){ ?>
                                                    <button data-prompt-msg="⚠️ Apakah Anda yakin ingin menghapus data ini?" data-display-style="modal" data-url="<?php print_link("matrik_translok/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
