...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Matrik Translok dengan SP2D CLEAR</h4>
                </div>
                <div class="col-sm-3 ">
                </div>
                <div class="col-md-12 comp-grid">
                    <form  class="search" action="<?php print_link('matrik_translok/list_sp2d_clear'); ?>" method="get">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="matrik_translok-list_sp2d_clear-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-list_petugas"><a href="<?php print_link("detail_matrik_translok/list_sp2d_clear/id_matrik_translok/$data[id]") ?>"><?php echo $data['list_petugas']; ?></a></td>
