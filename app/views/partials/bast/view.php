...
function hitung_terbilang_tanggal($tanggal){
    ...
    return [
        ...
        'tahun_terbilang' => tahun_terbilang((int)$tahun),
    ];
}
...
$tgl = hitung_terbilang_tanggal($data['tgl_bast'] ?? null);
//$tgl = hitung_terbilang_tanggal(date('Y-m-d'));
...
<p style="text-align: justify; margin-top: 10px;">
    Pada hari ini <?= $tgl['hari']; ?>, tanggal <?= $tgl['tanggal_terbilang']; ?>, 
    bulan <?= $tgl['bulan_terbilang']; ?>, tahun <?= $tgl['tahun_terbilang']; ?>, 
