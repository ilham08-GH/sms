    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('master_petugas/'); ?>" method="get">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="master_petugas-list_petugas_cekid-records">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("master_petugas/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-nik">
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip" title="Lihat Data" href="<?php print_link("master_petugas/view/$rec_id"); ?>">
