...
class Cek_honor_petugas_viewController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$this->view->search_template = "cek_honor_petugas_view/search.php";
		}
		...
		$this->render_view("cek_honor_petugas_view/list.php", $data); //render the full page
	}
