...
define("APP_ID", "9a698a58a304f16be22eb336419780fc");

// Application Default Color (Mostly Used By Mobile)
define("META_THEME_COLOR", "#191970");
...
define("SMTP_USERNAME", "gresikkab.bps@gmail.com");
define("SMTP_PASSWORD", "dyse snuj bkkr wscv");
define("SMTP_HOST", "smtp.gmail.com");
define("SMTP_PORT", "465");

//Default Email Sender Details. Please set this even if you are not using SMTP
define("DEFAULT_EMAIL", "gresikkab.bps@gmail.com");
define("DEFAULT_EMAIL_ACCOUNT_NAME", "Simasnor BPS Gresik");

// Database Configuration Settings
define("DB_HOST", "localhost");
define("DB_USERNAME", "root");
define("DB_PASSWORD", "");
define("DB_NAME", "simasnor");
...
define('USER_NIP', (isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['nip'] : null));
